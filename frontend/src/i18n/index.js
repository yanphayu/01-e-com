...
const messages = {
  en: {
    ...
    'auth.selectLocationOnMap': 'Select location on map',
    'auth.clickOnMap': 'Click on the map to select a location',
    'auth.gettingAddress': 'Getting address',
    ...
    'auth.deleteOtpLabel': 'Verification code',
    'auth.deleteOtpPlaceholder': '6-digit code',
    'auth.sendCode': 'Send code',
    'auth.resendCode': 'Resend code',
    'auth.deleteOtpSent': 'A verification code was sent to your email.',
    'auth.deletePasswordRequired': 'Enter your current password to confirm deletion.',
    'auth.deleteOtpRequired': 'Enter the verification code sent to your email.',
    ...
    'product.postedSuccess': 'Your product has been posted successfully.',
    ...
    'product.phonePlaceholder': '012 345 678',
    ...
    'chat.productDraft': 'Forwarding product',
    'chat.removeDraft': 'Remove product',
    ...
    'chat.msgDeleted': 'This message was deleted',
    'chat.msgDeletedYou': 'You deleted this message',
    'chat.confirmDeleteMsg': 'Delete this message?',
    ...
    'chat.stopRecording': 'Stop and send',
    'chat.cancelRecording': 'Cancel',
    'chat.voiceUnavailable': 'Microphone unavailable. Allow mic access and try again.',
    'chat.imageUnsupported': 'That file type is not supported as an image.',
    'chat.imageTooMany': 'You can send up to 10 images per message.',
    'chat.details': 'Details',
    'chat.viewProfile': 'View profile',
    'chat.name': 'Name',
    'chat.email': 'Email',
    'chat.birthday': 'Birthday',
    'chat.memberSince': 'Member since',
    'chat.mediaLinks': 'Media, files and links',
    'chat.photos': 'photos',
    'chat.viewAllPhotos': 'View all photos',
    'chat.photosHeader': 'Photos',
    'chat.blockUser': 'Block user',
    'chat.close': 'Close',
    'chat.voice': 'Voice message',
    'nav.chat': 'Chat',

    'report.title': 'Report this product',
    'report.button': 'Report',
    'report.reason': 'Reason',
    'report.reasonPlaceholder': 'Select a reason',
    'report.details': 'Details (optional)',
    'report.detailsPlaceholder': 'Tell us more...',
    'report.submit': 'Submit report',
    'report.submitting': 'Submitting...',
    'report.success': 'Thanks! Your report has been sent to our team.',
    'report.failed': 'Something went wrong. Please try again.',
    'report.reason_spam': 'Spam',
    'report.reason_fraud': 'Fraud / Scam',
    'report.reason_fake': 'Counterfeit product',
    'report.reason_inappropriate': 'Inappropriate content',
    'report.reason_duplicate': 'Duplicate listing',
  ...
  kh: {
    ...
    'auth.location': 'ទីតាំង',
    'auth.selectLocationOnMap': 'ជ្រើសរើសទីតាំងនៅលើផែនទី',
    'auth.clickOnMap': 'ចុចលើផែនទីដើម្បីជ្រើសរើសទីតាំង',
    'auth.gettingAddress': 'កំពុងទាញយកអាសយដ្ឋាន',
    ...
    'auth.currentPasswordPlaceholder': 'បញ្ចូលពាក្យសម្ងាត់បច្ចុប្បន្នរបស់អ្នក',
    'auth.deleteOtpLabel': 'លេខកូដផ្ទៀងផ្ទាត់',
    'auth.deleteOtpPlaceholder': 'កូដ ៦ ខ្ទង់',
    'auth.sendCode': 'ផ្ញើលេខកូដ',
    'auth.resendCode': 'ផ្ញើម្ដងទៀត',
    'auth.deleteOtpSent': 'លេខកូដផ្ទៀងផ្ទាត់ត្រូវបានផ្ញើទៅកាន់អ៊ីមែលរបស់អ្នក។',
    'auth.deletePasswordRequired': 'បញ្ចូលពាក្យសម្ងាត់បច្ចុប្បន្នដើម្បីបញ្ជាក់ការលុប។',
    'auth.deleteOtpRequired': 'បញ្ចូលលេខកូដផ្ទៀងផ្ទាត់ដែលបានផ្ញើទៅអ៊ីមែលរបស់អ្នក។',
    ...
    'nav.browseCategories': 'រុករកប្រភេទ',
    ...
    'product.conditionUsed': 'ប្រើប្រាស់រួច',
    ...
    'product.filterByProvince': 'ត្រងតាមខេត្ត',
    ...
    'chat.productDraft': 'ផ្ញើផលិតផល',
    'chat.removeDraft': 'លុបផលិតផល',
    'chat.archived': 'បណ្ណសារ',
    'chat.more': 'ជម្រើសបន្ថែម',
    'chat.markUnread': 'សម្គាល់ថាមិនទាន់អាន',
    'chat.pin': 'ខ្ទាស់',
    'chat.unpin': 'ដោះខ្ទាស់',
    'chat.mute': 'បិទសំឡេង',
    'chat.unmute': 'បើកសំឡេង',
    'chat.archive': 'ទុកក្នុងបណ្ណសារ',
    'chat.unarchive': 'ដកចេញពីបណ្ណសារ',
    'chat.delete': 'លុប',
    'chat.block': 'រារាំង',
    'chat.you': 'អ្នក',
    'chat.reply': 'ឆ្លើយតប',
    ...
    'chat.edit': 'កែសម្រួល',
    'chat.edited': 'កែរួច',
    'chat.forwarded': 'បញ្ជូនបន្ត',
    'chat.msgDeleted': 'សារនេះត្រូវបានលុប',
    'chat.msgDeletedYou': 'អ្នកបានលុបសារនេះ',
    'chat.confirmDeleteMsg': 'លុបសារនេះ?',
    'chat.forwardTo': 'បញ្ជូនបន្តទៅ',
    'chat.replyTo': 'ឆ្លើយតបទៅ',
    'chat.editing': 'កំពុងកែសម្រួល',
    'chat.photo': 'រូបថត',
    'chat.voiceMessage': 'សារសំឡេង',
    'chat.reactions': 'ប្រតិកម្ម',
    'chat.recording': 'កំពុងថត...',
    'chat.stopRecording': 'ឈប់ហើយផ្ញើ',
    'chat.cancelRecording': 'បោះបង់',
    'chat.voiceUnavailable': 'មីក្រូហ្វូនមិនមានទេ។ អនុញ្ញាតិឱ្យចូលប្រើមីក្រូហ្វូន រួចព្យាយាមម្តងទៀត។',
    'chat.imageUnsupported': 'ប្រភេទឯកសារនេះមិនគាំទ្រ​ជារូបភាពទេ។',
    'chat.imageTooMany': 'អ្នកអាចផ្ញើរូបភាពបានតែ ១០ ក្នុងមួយសារប៉ុណ្ណោះ។',
    'chat.details': 'ព័ត៌មានលម្អិត',
    'chat.viewProfile': 'មើលប្រវត្តិ',
    'chat.name': 'ឈ្មោះ',
    'chat.email': 'អ៊ីមែល',
    'chat.birthday': 'ថ្ងៃខែឆ្នាំកំណើត',
    'chat.memberSince': 'សមាជិកតាំងពី',
    'chat.mediaLinks': 'រូបភាព ឯកសារ និងតំណ',
    'chat.photos': 'រូបភាព',
    'chat.viewAllPhotos': 'មើលរូបភាពទាំងអស់',
    'chat.photosHeader': 'រូបភាព',
    'chat.photos': 'រូបភាព',
    ...
    'report.title': 'រាយការណ៍ផលិតផលនេះ',
    'report.button': 'រាយការណ៍',
    'report.reason': 'មូលហេតុ',
    'report.reasonPlaceholder': 'ជ្រើសរើសមូលហេតុ',
    'report.details': 'ព័ត៌មានលម្អិត (ស្រេចចិត្ត)',
    'report.detailsPlaceholder': 'ប្រាប់យើងបន្ថែម...',
    'report.submit': 'ដាក់ស្នើរបាយការណ៍',
    'report.submitting': 'កំពុងដាក់ស្នើ...',
    'report.success': 'សូមអរគុណ! របាយការណ៍របស់អ្នកត្រូវបានផ្ញើទៅក្រុមរបស់យើង។',
    'report.failed': 'មានបញ្ហាអ្វីមួយ។ សូមព្យាយាមម្តងទៀត។',
    'report.reason_spam': 'ស្ប៉ាម',
    'report.reason_fraud': 'បន្លំបោកប្រាស់',
    'report.reason_fake': 'ផលិតផលក្លែងក្លាយ',
    'report.reason_inappropriate': 'ខ្លឹមសារមិនសមរម្យ',
    'report.reason_duplicate': 'ការផ្សាយចម្លង',
    'report.reason_other': 'ផ្សេងទៀត',
  },
}
